...
const { BundleAnalyzerPlugin } = require('webpack-bundle-analyzer'); // todo: unused
const { CleanWebpackPlugin } = require('clean-webpack-plugin'); // todo: unused
...
module.exports = ({ production } = {}, {extractCss, analyze, tests, hmr, port, host } = {}) => ({
    ...
    module: {
        rules: [
            // CSS required in JS/TS files should use the style-loader that
            // auto-injects it into the website only when the issuer is a .js/.ts file,
            // so the loaders are not applied inside html templates
            {
                test: /\.css$/i,
